...
GridStore.prototype.puts = function(string, options, callback) {
    ...
    return executeLegacyOperation(
        this.db.s.topology,
        this.write.bind(this), [finalString, options, callback], { skipSessions: true }
    );
};
...
GridStore.prototype.write = function write(data, close, options, callback) {
    ...
    return executeLegacyOperation(
        this.db.s.topology,
        _writeNormal, [this, data, close, options, callback], { skipSessions: true }
    );
};
...
GridStore.prototype.readlines = function(separator, options, callback) {
    ...
    return executeLegacyOperation(
        this.db.s.topology,
        readlines, [this, separator, options, callback], { skipSessions: true }
    );
};
...
GridStore.prototype.read = function(length, buffer, options, callback) {
    ...
    return executeLegacyOperation(
        this.db.s.topology,
        read, [this, length, buffer, options, callback], { skipSessions: true }
    );
};
...
GridStore.prototype.seek = function(position, seekLocation, options, callback) {
    ...
    return executeLegacyOperation(
        this.db.s.topology,
        seek, [this, position, seekLocation, options, callback], { skipSessions: true }
    );
};
...
GridStore.exist = function(db, fileIdObject, rootCollection, options, callback) {
    ...
    return executeLegacyOperation(
        db.s.topology,
        exists, [db, fileIdObject, rootCollection, options, callback], { skipSessions: true }
    );
};
...
var exists = function(db, fileIdObject, rootCollection, options, callback) {
    ...
    db.collection(rootCollectionFinal + '.files', function(err, collection) {
        ...
        var query =
            ...
            Object.prototype.toString.call(fileIdObject) === '[object RegExp]' ? { filename: fileIdObject } : { _id: fileIdObject }; // Attempt to locate file
...
GridStore.read = function(db, name, length, offset, options, callback) {
    ...
    return executeLegacyOperation(
        db.s.topology,
        readStatic, [db, name, length, offset, options, callback], { skipSessions: true }
    );
};
...
GridStore.readlines = function(db, name, separator, options, callback) {
    ...
    return executeLegacyOperation(
        db.s.topology,
        readlinesStatic, [db, name, separator, options, callback], { skipSessions: true }
    );
};
